const Map<String, String> englishStrings = {
  ...
  // ── Analytics / BI Screen ──
  'royal_stitch_bi': 'Royal Stitch BI',
  'total_revenue': 'Total Revenue',
  'revenue_trend_pct': '↗ +14% vs last month',
  'active_orders': 'Active Orders',
  'scheduled_this_week': '7 scheduled this week',
  'revenue_trend': 'Revenue Trend',
  'six_months': '6 Months',
  'client_retention': 'Client Retention',
  'loyalty_upper': 'LOYALTY',
  'repeat_customer_prefix': 'Repeat customer rate is ',
  'repeat_customer_highlight': 'up 4%',
  'repeat_customer_suffix': ' from Q1\nperformance.',
  'ai_business_strategy': 'AI Business Strategy',
  'supply_insight_tag': 'SUPPLY INSIGHT',
  'high_demand_alert_title': 'High Demand Alert: ',
  'high_demand_alert_desc': 'Loro Piana fabrics are trending. Suggest increasing inventory by ',
  'high_demand_alert_highlight': '20%.',
  'adjust_inventory': 'Adjust Inventory',
  'ops_efficiency_tag': 'OPS EFFICIENCY',
  'lead_time_opt_title': 'Lead Time Optimization: ',
  'lead_time_opt_desc': 'Reducing bespoke lead time to 3.5 weeks could increase capacity by ',
  'lead_time_opt_highlight': '12%.',
  'review_staffing': 'Review Staffing',
  'revenue_by_category': 'Revenue by Category',
  'bespoke_suits': 'Bespoke Suits',
  'evening_gowns': 'Evening Gowns',
  'luxury_shirts': 'Luxury Shirts',
